            ...
            <div class="table-responsive">
                <table class="table text-nowrap">
                    ...
                    <tr>
                        <td>
                            <div class="media-left media-middle">
                                <a href="#"><img src="template/assets/images/brands/facebook.png" class="img-circle img-xs" alt=""></a>
                            </div>
                            <div class="media-left">
                    ...
                    <tr>
                        <td>
                            <div class="media-left media-middle">
                                <a href="#"><img src="{{asset('template/assets/images/brands/youtube.png')}}" class="img-circle img-xs" alt=""></a>
                            </div>
                            <div class="media-left">
                    ...
                    <tr>
                        <td>
                            <div class="media-left media-middle">
                                <a href="#"><img src="{{asset('template/assets/images/brands/spotify.png')}}" class="img-circle img-xs" alt=""></a>
                            </div>
                            <div class="media-left">
                    ...
                    <tr>
                        <td>
                            <div class="media-left media-middle">
                                <a href="#"><img src="{{asset('template/assets/images/brands/twitter.png')}}" class="img-circle img-xs" alt=""></a>
                            </div>
                            <div class="media-left">
                    ...
                    <tr>
                        <td>
                            <div class="media-left media-middle">
                                <a href="#"><img src="{{asset('template/assets/images/brands/bing.png')}}" class="img-circle img-xs" alt=""></a>
                            </div>
                            <div class="media-left">
                    ...
                    <tr>
                        <td>
                            <div class="media-left media-middle">
                                <a href="#"><img src="{{asset('template/assets/images/brands/amazon.png')}}" class="img-circle img-xs" alt=""></a>
                            </div>
                            <div class="media-left">
                    ...
                    <tr>
                        <td>
                            <div class="media-left media-middle">
                                <a href="#"><img src="{{asset('template/assets/images/brands/dribbble.png')}}" class="img-circle img-xs" alt=""></a>
                            </div>
                            <div class="media-left">
            ...
            <div class="table-responsive">
                <table class="table text-nowrap">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="media-left media-middle">
                                <a href="#"><img src="{{asset('template/assets/images/placeholder.jpg')}}" class="img-circle img-xs" alt=""></a>
                            </div>
                        ...
                        <ul class="media-list content-group">
                            <li class="media stack-media-on-mobile">
                                <div class="media-left">
                                    <div class="thumb">
                                        <a href="#">
                                            <img src="{{asset('template/assets/images/placeholder.jpg')}}" class="img-responsive img-rounded media-preview" alt="">
            ...
            <div class="tab-content">
                <div class="tab-pane active fade in has-padding" id="messages-tue">
                    <ul class="media-list">
                        <li class="media">
                            <div class="media-left">
                                <img src="{{asset('template/assets/images/placeholder.jpg')}}" class="img-circle img-xs" alt="">
                ...
                <div class="tab-pane fade has-padding" id="messages-mon">
                    <ul class="media-list">
                        <li class="media">
                            <div class="media-left">
                                <img src="{{asset('template/assets/images/placeholder.jpg')}}" class="img-circle img-sm" alt="">
                            </div>
